...
\begin{eqnarray}
   \nonumber
   b^2 - 4ac &=& \left[1 - \alpha_3^2\right] x_2^2 + \left[1 -
                 \alpha_2^2\right] y_3^2 - \left[\tau_2^2 + \tau_3^2\right] +\\
   \nonumber
   &&
                 \alpha_2^2 \tau_3^2 + \alpha_3^2 \tau_2^2 - \left[1 -
                 \alpha_2^2\right] \left[1 - \alpha_3^2\right] \left[\tau_2 -
                 \tau_3\right]^2.
\end{eqnarray}
